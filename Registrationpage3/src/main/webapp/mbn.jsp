...
<body>
<nav class="navbar">
  <div class="logo">Smart City Guide - Mahabubnagar</div>
  <ul class="nav-links">
    <li><a href="mbnfamousplaces.jsp">Famous Places</a></li>
    <li><a href="mbnrestaurants.jsp">Restaurants</a></li>
    <li><a href="mbnhospitals.jsp">Hospitals</a></li>
    <li><a href="mbnhotels.jsp">Hotels & Lodges</a></li>
  </ul>
</nav>
