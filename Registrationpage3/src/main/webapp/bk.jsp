...
<nav class="navbar">
  <div class="logo">Smart City Guide - Bhadradri Kothagudem</div>
  <ul class="nav-links">
    <li><a href="bkfamousplaces.jsp">Famous Places</a></li>
    <li><a href="bkrestaurants.jsp">Restaurants</a></li>
    <li><a href="bkhospitals.jsp">Hospitals</a></li>
    <li><a href="bkhotels.jsp">Hotels & Lodges</a></li>
  </ul>
</nav>
...
<section class="image-gallery">
  ...
  <div class="gallery-grid-three">
    ...
    <div class="place">
      ...
      <p>Famous temple dedicated to Lord Rama, located on the banks of the Godavari River.</p>
    ...
    <div class="place">
      ...
      <h2>Papi Hills</h2>
      <p>Scenic hill range with Godavari river cruise, perfect for eco-tourism and trekking.</p>
      <a class="btn" href="https://www.google.com/maps?q=Papi+Hills+Godavari" target="_blank">Get Directions</a>
    </div>

    <div class="place">
      <img src="bk images/kpkd.jpg" alt="Kinnerasani Dam">
      <h2>Kinnerasani Dam & Wildlife Sanctuary</h2>
      <p>Popular picnic spot with a dam, boating, and a nearby wildlife sanctuary.</p>
    ...
    <div class="place">
      ...
      <p>Often called the "Niagara of Telangana", a picturesque and accessible waterfall spot.</p>
    ...
    <div class="place">
      ...
      <h2>Parnasala</h2>
      <p>Mythologically significant village believed to be the place of Lord Rama’s exile stay.</p>
      <a class="btn" href="https://www.google.com/maps?q=Parnasala+Bhadradri" target="_blank">Get Directions</a>
    </div>
