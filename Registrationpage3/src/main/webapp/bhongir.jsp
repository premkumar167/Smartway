...
<nav class="navbar">
  ...
  <ul class="nav-links">
    <li><a href="bnrfamousplaces.jsp">Famous Places</a></li>
    <li><a href="bnrrestaurants.jsp">Restaurants</a></li>
    <li><a href="bnrhospitals.jsp">Hospitals</a></li>
    <li><a href="bnrhotels.jsp">Hotels & Lodges</a></li>
  </ul>
</nav>
