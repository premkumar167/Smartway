...
<nav class="navbar">
  <div class="logo">Smart City Guide - Mancherial</div>
  <ul class="nav-links">
    <li><a href="mnclfamousplaces.jsp">Famous Places</a></li>
    <li><a href="mnclrestaurants.jsp">Restaurants</a></li>
    <li><a href="mnclhospitals.jsp">Hospitals</a></li>
    <li><a href="mnclhotels.jsp">Hotels & Lodges</a></li>
  </ul>
</nav>
